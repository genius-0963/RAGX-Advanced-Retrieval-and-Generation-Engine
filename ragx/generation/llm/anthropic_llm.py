"""
RAGX Anthropic LLM — Claude integration via LangChain.

Provides ``AnthropicLLM``, a concrete implementation of ``BaseLLM`` that
wraps ``langchain_anthropic.ChatAnthropic`` for Claude-family models.
"""
...
class AnthropicLLM(BaseLLM):
    """Anthropic Claude integration using ``langchain_anthropic.ChatAnthropic``.
    ...
    def __init__(
        ...
        """Initialise the Anthropic chat model.

        Args:
            model:       Anthropic model identifier.
            api_key:     Anthropic API key.  Falls back to settings / env var.
    ...
    def generate(
        ...
        """Generate a complete answer using Anthropic Claude.
